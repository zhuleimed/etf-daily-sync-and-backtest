...
**⑭ composite_momentum — 复合动量轮动（+119%, 夏普1.25）⚠️ 保留风控B**
(注意：与ADX不同，composite_momentum是多因子策略，**应保留风控B模式**——
B模式收益+119%远优于A模式的+69%，回撤-17%远优于A模式的-27%。)
...
| 7 | bollinger 布林带 | +108% | 1.10 | -20% | 38% | 217 |
| 8 | **RSI趋势确认** | **+82%** | **1.15** | **-13%** | **32%** | **44** |
