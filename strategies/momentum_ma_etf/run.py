#!/usr/bin/env python3
"""
动量+均线过滤（逐ETF）轮动策略 — 入口脚本

用法:
  python strategies/momentum_ma_etf/run.py
  python strategies/momentum_ma_etf/run.py --start 2024-01-01 --tag test1
"""
...
def main():
    ...
    if MA_FILTER_ENABLED:
        print(f"  均线过滤: 每只ETF需高于自身{MA_FILTER_PERIOD}日均线")
    print(f"  {'=' * 55}")
