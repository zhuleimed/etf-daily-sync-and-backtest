...
用法:
  # 默认参数回测（2024-01-01 → 最新）
  python strategies/rsi_trend_rotation/run.py
...
def main():
    ...
    print(f"  核心逻辑: RSI(14)>50 多头过滤 + RSI值/RSI斜率/短期动量 综合评分")
    print(f"  {'=' * 55}")
