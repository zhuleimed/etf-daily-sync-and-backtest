...
from strategies.sharpe_ranking.momentum_signals import compute_sharpe_signals, rank_etfs_by_sharpe
...
def main():
    ...
    engine = DailySimEngine(state_mgr=state_mgr, broker=broker, config={"initial_capital": INITIAL_CAPITAL},
        signal_func=compute_sharpe_signals, rank_func=rank_etfs_by_sharpe,
